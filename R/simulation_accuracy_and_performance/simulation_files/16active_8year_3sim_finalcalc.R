# summarise primary 3 setting simulation results
library(tidyverse)
library(rstan)
set.seed(1234)
...
# read in the results -----------------------------------------------------
res_name_suffix <- "16active_8yearsim_3diff_res_seed_"
...
glm_summary <- vector(mode = "list", length = 1)
...
res_name_suffix <- "8year_3diff_standraws_seed_"
# list all the setting descriptors
...
write_rds(acc, "16active_8year_3diff_acc_tablesv2.rds")
write_rds(final_summary, "16active_8year_3diff_sim_or_tablesv2.rds")
