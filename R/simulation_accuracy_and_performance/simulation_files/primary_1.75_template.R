...
# Primary simulation setting 1.75 as described in manuscript
# Run for seeds 1 to 110 to replicate manuscript analysis
library(nosoi)  
library(tidyverse)
library(TransPhylo)
library(ape)
...
write_rds(results, str_c("16active_8yearsim_1.75diff_res_seed_", seed, ".rds", ""))
