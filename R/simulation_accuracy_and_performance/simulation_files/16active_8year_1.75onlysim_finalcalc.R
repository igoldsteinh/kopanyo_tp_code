# summarise Primary 1.75 simulation results
library(tidyverse)
library(rstan)
set.seed(1234)
...
res_name_suffix <- "8year_1.75diff_standraws_seed_"
...
write_rds(acc, "16active_8year_1.75only_acc_tables.rds")
write_rds(final_summary, "16active_8year_1.75only_sim_or_tables.rds")
