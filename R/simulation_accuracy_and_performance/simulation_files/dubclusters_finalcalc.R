# this file summarises increase sample size simulation results
library(tidyverse)
library(rstan)
set.seed(1234)
...
# read in the results -----------------------------------------------------
res_name_suffix <- "16active_8yearsim_1.75diff_dubclusters_res_seed_"
...
res_name_suffix <- "dubclusters_standraws_seed_"
...
write_rds(acc, "dubclusters_acc_tables.rds")
write_rds(final_summary, "dubclusers_sim_or_tables.rds")
