...
# Secondary simulation setting "increase clusters" as described in manuscript
# run for seeds 1 to 120
library(nosoi)  
library(tidyverse)
library(TransPhylo)
library(ape)
...
write_rds(results, str_c("16active_8yearsim_1.75diff_dubclusters_res_seed_", seed, ".rds", ""))
