# summarise primary 0.57 simulation results
library(tidyverse)
library(rstan)
set.seed(1234)
...
# read in the results -----------------------------------------------------
res_name_suffix <- "16active_8yearsim_0.6diff_res_seed_"

# list all the setting descriptors
setting <- "16active_8year_0.6diff"
...
res_name_suffix <- "16active_8year_0.6diff_standraws_seed_"
...
write_rds(acc, "16active_8year_0.6diff_acc_tables.rds")
write_rds(final_summary, "16active_8year_0.6diff_sim_or_tables.rds")
