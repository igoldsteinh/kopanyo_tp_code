# summarise primary 1 simulation results
library(tidyverse)
library(rstan)
set.seed(1234)
...
res_name_suffix <- "16active_8year_samediff_standraws_seed_"
...
write_rds(acc, "16active_8year_samediff_acc_tables.rds")
write_rds(final_summary, "16active_8year_samediff_sim_or_tables.rds")
