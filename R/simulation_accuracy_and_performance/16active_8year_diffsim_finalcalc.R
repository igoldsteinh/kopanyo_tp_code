...
# read in the results -----------------------------------------------------
res_name_suffix <- list("16active_8yearsim_samediff_res_seed_",
                        "16active_8yearsim_0.3diff_res_seed_")

# res_name_suffix <- list("fulloutbreak_sim_res_seed_",
#                         "fulloutbreak_highsample_sim_res_seed_")
# list all the setting descriptors
setting <- list("16active_8year_samediff",
                "16active_8yearsim_0.3diff"
              )
...
write_rds(acc, "16active_8year_acc_tables.rds")
write_rds(test_summary, "16active_8year_sim_or_tables.rds")
