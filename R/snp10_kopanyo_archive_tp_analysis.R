...
#          mutate(cuttoff = count * 2 -2, 
#                 include = var_sites_num >= cuttoff) %>%
#          filter(include == TRUE) %>%
#          mutate(clock_start = (4.2E6/var_sites_num) * 1E-7,
#                 clock_lb = (4.2E6/var_sites_num) * 1E-8,
#                 clock_ub = (4.2E6/var_sites_num) * 5E-7)

# write_csv(dict10,here::here("data", "snp_10_kopanyo_cluster_dictionary.csv") )
# reduce to varsites ------------------------------------------------------
# dict10 <-read_csv(here::here("data", "snp_10_kopanyo_cluster_dictionary.csv"))
# 
# file_list <- dict10$file_name
...
#   unlist()
# 
# map2(file_list, samples_varsites,
...
# create dat for analysis all share ---------------------------------------
